                                                ...
                                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                                                    <tbody>
                                                        ...
                                                        {{-- <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family:Muli, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:left;color:#333333;">
                                                                    For more details, visit your <a target="_blank" href="{{ route('posts.index') }}">posts list</a> or contact support.
                                                                </div>
                                                            </td>
                                                        </tr> --}}
                                                        ...
                                                        <tr>
                                                            <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                                                <div style="font-family:Muli, Arial, sans-serif;font-size:14px;font-weight:400;line-height:20px;text-align:left;color:#333333;">
                                                                    Please make sure to review our <a target="_blank" href="{{ route("web.index") }}">site policy</a> to avoid any future issues.
                                                                </div>
                                                            </td>
                                                        </tr>
