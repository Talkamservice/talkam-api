                    ...
                    <div class="card-body">
                        <form
                            ...
                            <div class="gy-4 mb-4">
                                ...
                                <div class="row col-xl-9 col-sm-12">
                                    <label for="input-placeholder"
                            ...
                            <div class="mb-4">
                                @foreach ($featureCards ?? [] as $key => $value)
                                    <div class="row col-xl-4 col-sm-12 mt-3 align-items-center">
                                        <div class="col-2">
                                            <input type="checkbox" class="form-check" name="feature_cards[{{ $key }}]"
                                                {{ in_array($key, isset($plan) ? $plan?->feature_cards ?? [] : []) ? 'checked' : '' }}
                            ...
                            <hr class="mt-4">
                            <div class="col-xl-9 col-sm-12 d-flex mb-4 align-items-center justify-content-between ">
                                Add Duration Prices
                                <div class="row col-xl-9 col-sm-12 addPlanDurationDiv">
                                            ...
                                            <div class="row col-xl-9 col-sm-12 mb-3">
                                                ...
                                                <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                                                    <input type="number" class="form-control" name="discount[]"
                                                        value="{{ $plan_duration->discount }}" id="contact-input"
                                                        placeholder="Enter plan discount" oninput="validateDiscount(this)">
                                                </div>
                                            </div>
                                        </div>
                                    @endforeach
                            ...
                            @else
                                <div class="" id="planDuration">
                                    <div class="plan-duration-section">
                                        <div class="row col-xl-9 col-sm-12 mb-3 frequencyDiv">
                                            <label for="input-placeholder"
                                                class="form-label col-xl-2 col-lg-2 col-md-2 col-sm-2">Frequency</label>
                                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                                                <select name="frequency[]" id="" class="form-control">
                                        ...
                                        <div class="row col-xl-9 col-sm-12 mb-3">
                                            ...
                                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12">
                                                <input type="number" class="form-control" name="discount[]"
                                                    oninput="validateDiscount(this)" id="contact-input"
                                    ...
                                    <div class="row col-xl-4 col-sm-12 mt-3 align-items-center">
                                        <div class="col-2">
                                            <input type="checkbox" class="form-check"
                                                name="benefits[{{ $key }}]"
                                                {{ in_array($key, $benefit_keys) ? 'checked' : '' }} id=""
