                                                        ...
                                                        <form id="suspendUser_{{ $user->id }}"
                                                            ...
                                                            @if ($user->status == 'Active')
                                                                ...
                                                                <a class="dropdown-item text-warning" href="#"
                                                                    onclick="$('#suspendUser_{{ $user->id }}').submit()"><i
                                                                        class="ri-close-line"></i> | Suspend </a>
                                                            @else
                                                                <input type="hidden" name="status" value="Active">
                                                                <a class="dropdown-item text-warning" href="#"
                                                                    onclick="$('#suspendUser_{{ $user->id }}').submit()"><i
                                                                        class="ri-check-line"></i> | Activate</a>
                                                            @endif
                                                        </form>
                                                    </li>
                                                    <li>
                                                        <form id="strikeUser_{{ $user->id }}"
                                                            action="{{ route('admin.users.strike', $user->id) }}"
                                                            method="post"
                                                            onsubmit="return confirm('Are you sure of this action?')"> @csrf
                                                            <a class="dropdown-item text-warning" href="#"
                                                                onclick="$('#strikeUser_{{ $user->id }}').submit()"><svg
                                                    ...
                                                    <li>
                                                        <form id="deleteUser_{{ $user->id }}"
                                                            ...
                                                            <a class="dropdown-item text-danger"
                                                                onclick="$('#deleteUser_{{ $user->id }}').submit()"
                                                                href="#"><i class="ri-delete-bin-line"></i> |
                                                                Delete</a>
                                                        </form>
                                                    </li>
