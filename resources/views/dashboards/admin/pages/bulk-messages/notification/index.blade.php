    ...
    <div class="container-fluid">
        ...
        <div class="d-md-flex d-block align-items-center justify-content-between my-4 page-header-breadcrumb">
            ...
            <div class="ms-md-1 ms-0 d-flex align-items-center">
                ...
                <a href="{{ route('admin.notifications.send-bulk-notification.create') }}"
                    class="btn btn-primary ms-3">Create</a>
            </div>
        </div>
                        ...
                        <table class="table text-nowrap table-hover border table-bordered">
                            ...
                            <tbody>
                                @forelse ($notifications as $notification)
                                    ...
                                    <!-- Hidden Delete Form -->
                                    <form id="deleteNotificationForm_{{ $notification->id }}"
                                        action="{{ route('admin.notifications.send-bulk-notification.destroy', $notification->id) }}"
