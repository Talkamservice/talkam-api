            ...
            <div class="ms-md-1 ms-0">
                <nav>
                    <ol class="breadcrumb mb-0">
                        <li class="breadcrumb-item"><a href="#">Avatars</a></li>
        ...
        <div class="col-xl-12">
            <div class="card custom-card">
                <div class="card-header d-flex justify-content-between">
                    ...
                    <div class="">
                        <a href="{{ route('admin.avatars.create') }}" class="btn btn-primary btn-sm"><i class="fe fe-plus"></i> <span class="ml-3">Create</span></a>
                    </div>
                </div>
                <div class="card-body">
                            ...
                            <tbody>
                                @forelse ($avatars as $avatar)
                                    <tr>
                                        ...
                                        <td>{{ $avatar->name }}</td>
                                        <td>{{ $avatar->description ?? "N/A"}}</td>
                                        <td>
                                            <span class="badge bg-{{ pillClasses($avatar->status) }}-transparent">
                                                {{ $avatar->status }}
                                            </span>
                                        </td>
                                        <td>{{ $avatar->created_at->format('Y-m-d h:i A') }}</td>
                                        <td>
