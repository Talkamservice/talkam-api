            ...
            <form method="GET" action="{{ route('admin.home') }}" class="d-inline">
                <div class="dropdown">
                    <button type="button" class="btn btn-primary btn-sm btn-wave waves-effect waves-light"
                        ...
                        Sort Stats By {{request()->period ?? 'month'}}<i class="ri-arrow-down-s-line align-middle ms-1 d-inline-block"></i>
                    </button>
                ...
                <input type="hidden" name="period" id="selected-period" value="{{ request('period', 'year') }}">
            </form>
            ...
            <div class="col-xxl-12 col-xl-12">
                <div class="row">
                    @foreach ($cards as $index => $card)
                        <div class="col-12 col-md-6 col-lg-6 col-xl-6 col-xxl-6" id="stats-content">
