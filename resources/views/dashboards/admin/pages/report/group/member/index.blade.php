                                            ...
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu">
                                                    ...
                                                    @can(slugPermission('ban a user'))
                                                        @if ($report->groupMember->user->status !== 'Banned')
                                                            <li>
                                                                <a class="dropdown-item text-danger" href="#"
                                                                    onclick="openBanUserModal('{{ $report->groupMember->user->id }}')"
                                                                    data-bs-toggle="tooltip" data-bs-placement="right"
                                                    ...
                                                    @can(slugPermission('suspend a user'))
                                                        <li>
                                                            @if ($report->groupMember->user->status === 'Inactive')
                                                                @can(slugPermission('unsuspend a user'))
                                                                    <a class="dropdown-item text-primary" href="#"
                                                                        onclick="openActionsModal('activate', '{{ route('admin.users.suspend', $report->groupMember->user->id) }}')">
                                                            ...
                                                            @else
                                                                @can(slugPermission('unsuspend a user'))
                                                                    <a class="dropdown-item text-warning" href="#"
                                                                        onclick="openSuspendUserModal('{{ $report->groupMember->user->id }}')"
                                                                        data-bs-toggle="tooltip" data-bs-placement="right"
