                                        ...
                                        <li>
                                            <form id="updateStatus_{{ $comment_report->id }}"
                                                ...
                                                <a class="dropdown-item text-success"
                                                   ...
                                                   href="#" data-bs-toggle="tooltip" title="Mark this report as resolved">
                                            ...
                                            <li>
                                                <form id="strikeUser_{{ $comment_report->comment->user->id }}"
                                                    ...
                                                    <a class="dropdown-item text-warning" href="#"
                                                       ...
                                                       data-bs-toggle="tooltip" title="Strike this user for a warning">
                                            ...
                                            <li>
                                                <form id="suspendUser_{{ $comment_report->comment->user->id }}"
                                                    ...
                                                    <a class="dropdown-item text-success" href="#"
                                                       onclick="event.preventDefault(); document.getElementById('suspendUser_{{ $comment_report->comment->user->id }}').submit()"
                                                       data-bs-toggle="tooltip" title="Activate this user">
                                    ...
                                    @if ($comment_report->status !== 'Resolved')
                                        <li>
                                            <a class="dropdown-item text-danger" href="#"
                                               ...
                                               data-bs-toggle="tooltip" title="Delete this report">
