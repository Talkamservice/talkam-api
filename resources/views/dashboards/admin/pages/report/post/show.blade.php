                            ...
                            <ul class="dropdown-menu">
                                <li>
                                    <a class="dropdown-item"
                                        href="{{ route('admin.reports.post.show', $post_report->id) }}"
                                ...
                                @if ($post_report->status !== 'Resolved')
                                    <li>
                                        <a class="dropdown-item text-success" href="#"
                                            onclick="openActionsModal('resolve', '{{ route('admin.reports.post.update-status', $post_report->id) }}')"
                                            data-bs-toggle="tooltip" data-bs-placement="right"
                                    ...
                                    @if ($post_report->post->user->status === 'Active')
                                        <a class="dropdown-item text-danger" href="#"
                                            onclick="openActionsModal('suspend', '{{ route('admin.users.suspend', $post_report->post->user->id) }}')"
                                            data-bs-toggle="tooltip" data-bs-placement="right"
                                            title="Suspend User">
                                    ...
                                    @else
                                        <a class="dropdown-item text-primary" href="#"
                                            onclick="openActionsModal('activate', '{{ route('admin.users.suspend', $post_report->post->user->id) }}')"
                                            data-bs-toggle="tooltip" data-bs-placement="right"
                                            title="Suspend User">
                                    ...
                                    <li>
                                        <a class="dropdown-item text-warning" href="#"
                                            onclick="openActionsModal('strike', '{{ route('admin.users.strike', $post_report->post->user->id) }}')"
                                            data-bs-toggle="tooltip" data-bs-placement="right"
                                ...
                                <li>
                                    <a class="dropdown-item text-danger" href="#"
                                        onclick="openActionsModal('delete', '{{ route('admin.reports.post.delete', $post_report->id) }}')"
                                        data-bs-toggle="tooltip" data-bs-placement="right"
                                        title="Delete Post">
                                ...
                                @if ($post_report->post && $post_report->post->user)
                                    <li>
                                        <a class="dropdown-item text-danger" href="#"
                                            onclick="openActionsModal('ban', '{{ route('admin.users.ban', $post_report->post->user->id) }}')"
                                            data-bs-toggle="tooltip" data-bs-placement="right"
                                            title="Ban User">
