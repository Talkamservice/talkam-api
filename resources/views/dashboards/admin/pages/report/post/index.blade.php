                                            ...
                                            <td>
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        @if ($first_report->status !== 'Resolved')
                                                            <li>
                                                                <a class="dropdown-item text-success" href="#"
                                                                    onclick="openActionsModal('resolve', '{{ route('admin.reports.post.update-status', $first_report->id) }}')"
                                                                    data-bs-toggle="tooltip" data-bs-placement="right"
                                                            ...
                                                            @if ($first_report->post->user->status === 'Active')
                                                                <a class="dropdown-item text-danger" href="#"
                                                                    onclick="openActionsModal('suspend', '{{ route('admin.users.suspend', $first_report->post->user->id) }}')"
                                                                    data-bs-toggle="tooltip" data-bs-placement="right"
                                                                    title="Suspend User">
                                                            ...
                                                            @else
                                                                <a class="dropdown-item text-primary" href="#"
                                                                    onclick="openActionsModal('activate', '{{ route('admin.users.suspend', $first_report->post->user->id) }}')"
                                                                    data-bs-toggle="tooltip" data-bs-placement="right"
                                                                    title="Suspend User">
                                                                    <i class="ri-close-line"></i> | Activate User
                                                                </a>
                                                            @endif
                                                            <li>
                                                                <a class="dropdown-item text-warning" href="#"
                                                                    onclick="openActionsModal('strike', '{{ route('admin.users.strike', $first_report->post->user->id) }}')"
                                                                    data-bs-toggle="tooltip" data-bs-placement="right"
                                                        ...
                                                        <li>
                                                            <a class="dropdown-item text-danger" href="#"
                                                                onclick="openActionsModal('delete', '{{ route('admin.reports.post.delete', $first_report->id) }}')"
                                                                data-bs-toggle="tooltip" data-bs-placement="right"
                                                                title="Delete Post">
                                                        ...
                                                        @if ($first_report->post && $first_report->post->user)
                                                            <li>
                                                                <a class="dropdown-item text-danger" href="#"
                                                                    onclick="openActionsModal('ban', '{{ route('admin.users.ban', $first_report->post->user->id) }}')"
                                                                    data-bs-toggle="tooltip" data-bs-placement="right"
                                                                    title="Ban User">
