                            ...
                            <tbody>
                                @forelse ($post_report_lists->groupBy('post_id') as $post_id => $post_reports)
                                    ...
                                    @if ($first_report && $first_report->post && $first_report->user)
                                        <tr>
                                            <td>
                                                <a class="text-primary" href="{{ route('admin.users.show', $first_report->user_id) }}">
                                            ...
                                            <td>
                                                <a class="text-primary" href="{{ url('https://web.talkam.prodevs.io/comment/' . $first_report->post->id) }}" target="_blank" rel="noopener noreferrer">
                                                        ...
                                                        <li>
                                                            <form id="suspendUser_{{ $first_report->id }}" action="{{ route('admin.users.suspend', $first_report->id) }}" method="post" onsubmit="return confirm('Are you sure of this action?')">
                                                                ...
                                                                @else
                                                                    ...
                                                                    <a class="dropdown-item text-success" href="#" onclick="$('#suspendUser_{{ $first_report->id }}').submit()"><i class="ri-check-line"></i> | Activate</a>
                                                                @endif
                                                            </form>
                                                        </li>
                                                        <li>
