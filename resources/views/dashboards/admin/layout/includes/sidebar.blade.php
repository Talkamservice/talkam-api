     ...
     <div class="main-sidebar " id="sidebar-scroll">
         ...
         <nav class="main-menu-container nav nav-pills flex-column sub-open">
             ...
             <ul class="main-menu">
                 ...
                 <!-- Start::slide__category -->
                 <li class="slide__category list-head-cont"><span class="category-name list-head">USER MANAGEMENT</span></li>
                 <!-- End::slide__category -->
                 ...
                 <!-- Start::slide__category -->
                 <li class="slide__category list-head-cont"><span class="category-name list-head">CONTENT MANAGEMENT</span></li>
                 <!-- End::slide__category -->
