...
class AnnouncementService
{
    ...
    public function send(array $data, $id = null)
    {
        ...
        if ($id) {
            ...
            (new ActivityLogService)
                ...
                ->setDescription((auth()->user()?->email) . " updated an announcement")
            ...
            (new ActivityLogService)
                ...
                ->setDescription((auth()->user()?->email) . " created an announcement")
                ->setType(ActivityLogConstants::SYSTEM_URL_TYPE)
    ...
    public static function delete(string $id)
    {
        ...
        (new ActivityLogService)
            ...
            ->setDescription((auth()->user()?->full_name ?? auth()->user()?->email) . " deleted an announcement")
            ->setType(ActivityLogConstants::SYSTEM_URL_TYPE)
    ...
    public function changeStatus(Request $request, $id)
    {
        ...
        (new ActivityLogService)
            ...
            ->setDescription((auth()->user()?->email) . " changed announcement status")
            ->setType(ActivityLogConstants::SYSTEM_URL_TYPE)
            ->setActivity(ActivitiesConstants::ANNOUNCEMENT_UPDATED)
            ->setModel(Announcement::class, $announcement->id)
            ->setAdmin(auth()->user()?->id)
