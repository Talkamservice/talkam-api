...
class NotificationService
{
    ...
    public function send(array $data, $notificationId = null)
    {
        ...
        if ($notificationId) {
            ...
            (new ActivityLogService)
                ...
                ->setDescription((auth()->user()?->email) . " updated a bulk notification")
            ...
            (new ActivityLogService)
                ...
                ->setDescription((auth()->user()?->email) . " created a bulk notification")
                ->setType(ActivityLogConstants::SYSTEM_URL_TYPE)
        ...
        if ($sendAt?->isPast() || is_null($sendAt)) {
            ...
            (new ActivityLogService)
                ...
                ->setDescription((auth()->user()?->email) . " sent a bulk notification")
                ->setType(ActivityLogConstants::SYSTEM_URL_TYPE)
    ...
    public function delete(string $id)
    {
        ...
        (new ActivityLogService)
            ...
            ->setDescription((auth()->user()?->email) . " deleted a bulk notification")
            ->setType(ActivityLogConstants::SYSTEM_URL_TYPE)
