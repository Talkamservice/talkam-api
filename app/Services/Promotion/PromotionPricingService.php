...
class PromotionPricingService
{
    ...
    public function create(array $data)
    {
        ...
        try {
            ...
            $data["max_daily_amount"] = $this->calcMaxAmount($data["amount"], $data["impressions"]);
    ...
    public function calcMaxAmount($amount, $impressions)
    {
        $post_performance = PostPerformance::whereNull("post_id")->whereNull("group_id")->first();
        $total_days = (divideNumber(1, $impressions)) * $post_performance->avg_impressions_per_day ?? 0;
