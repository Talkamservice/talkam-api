...
class PostCategoryController extends Controller
{
    ...
    {
        $categories = $this->post_category_service->list($request->all())->paginate(AppConstants::ADMIN_PAGINATION_SIZE);
    ...
    public function edit($category_id)
    {
        ...
        $categories = PostCategory::whereNotIn("id", [$category_id])->get();
        return view("dashboards.admin.pages.content.categories.create", [
            "categories" => $categories,
            "category" => $category,
            "statusOptions" => StatusConstants::ACTIVE_OPTIONS,
