...
class TherapistApplicationSubmittedNotification extends Notification
{
    ...
    public function buildData($notifiable)
    {
        return [
            ...
            'message' => "Your therapist application has been submitted. Verification takes 3-5 business days.",
